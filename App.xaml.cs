...
namespace Buddie
{
    public partial class App : Application
    {
        ...
        private void App_DispatcherUnhandledException(object sender, DispatcherUnhandledExceptionEventArgs e)
        {
            ...
            var localized1 = string.Format(System.Globalization.CultureInfo.InvariantCulture, tmpl1, e.Exception.Message);
        ...
        private void CurrentDomain_UnhandledException(object sender, UnhandledExceptionEventArgs e)
        {
            ...
            if (exception != null)
            {
                ...
                var localized2 = string.Format(System.Globalization.CultureInfo.InvariantCulture, tmpl2, exception.Message);
